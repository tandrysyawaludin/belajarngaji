...
export const id: Strings = {
  ...
  seoGamesBlurb:
    "Game belajar Al-Qur'an untuk anak: kuis arti surah, cocokkan, tebak ayat, sambung ayat, ular tangga, tic tac toe, petani blok, tukang burger, dan kotak rahasia.",
  ...
  cardGamesDesc: "Kuis, cocokkan, tebak ayat, tukang burger, kotak rahasia, dan game edukasi Al-Qur'an lainnya.",
  ...
  cardKotakTitle: "Kotak Rahasia",
  cardKotakDesc:
    "Jawab soal, buka 9 kotak harta. Beruntung dapat berlian, sial kosong!",
  cardTttTitle: "Tic Tac Toe",
  cardTttDesc:
    "Jawab soal, lalu taruh X atau O. Tiga deret menang!",
  ...
  kotakPageDesc:
    "Jawab soal dulu. Benar = pilih salah satu dari 9 kotak harta. Beruntung dapat berlian, sial kosong. Salah = Coba lagi. Pemenang mengumpulkan berlian terbanyak.",
  tttPageDesc:
    "Jawab soal dulu, lalu taruh tanda di papan. Solo lawan komputer. Tiga deret menang.",
  ...
  printPdf: "Cetak PDF",
  printPdfHint: "Buka dialog cetak, lalu pilih Simpan sebagai PDF",
  ...
  farmCarrotGoal: "Wortel: {current}/{goal}",
  farmCarrotsUnit: "wortel",
  farmPlotLabel: "Petak {n}",
  farmYourTurn: "Giliranmu",
  farmAnswerFirstShort: "Jawab dulu ya",
  farmAnswerQuestion: "Jawab Soal",
  farmAnswerFirstHint: "Jawab soal dulu baru bisa kerja di kebun!",
  farmChooseDestination: "Ketuk petak untuk berjalan",
  farmChooseAction: "Pilih kegiatan di petak ini",
  farmTapPlotHint: "Ketuk petak mana saja untuk berjalan.",
  farmActionKill: "Basmi Tikus",
  farmActionSeed: "Tanam Benih",
  farmActionWater: "Siram",
  farmActionHarvest: "Panen Wortel",
  ...
  kotakBoardTitle: "Kotak Rahasia",
  kotakAnswerQuestion: "Jawab Soal",
  kotakAnswerFirstHint: "Jawab soal dulu baru bisa buka kotak!",
  kotakAnswerFirstShort: "Jawab dulu ya",
  kotakChooseBox: "Pilih kotak harta!",
  kotakTryAgain: "Coba lagi",
  kotakOpeningHint: "Membuka kotak...",
  kotakDiamondHint: "Beruntung! Ada berlian!",
  kotakEmptyHint: "Kurang beruntung... kosong.",
  kotakBoxLabel: "Kotak {n}",
  kotakDiamondScore: "Berlian: {current}",
  kotakDiamondsUnit: "berlian",
  kotakFinishTitle: "Semua kotak terbuka!",
  tttBoardTitle: "Tic Tac Toe",
  tttAnswerFirst: "Jawab soal dulu baru boleh taruh tanda!",
  tttPickCell: "Pilih kotak kosong!",
  tttComputerTurn: "Komputer sedang berpikir...",
  tttYou: "Kamu",
  tttComputer: "Komputer",
  tttCellLabel: "Kotak",
  tttWinTitle: "Kamu menang!",
  tttLoseTitle: "Komputer yang menang.",
  tttDrawTitle: "Seri!",
  tttWinsUnit: "menang",
  gameLabels: {
    kuis: "Kuis Arti",
