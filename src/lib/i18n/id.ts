...
export const id: Strings = {
  ...
  farmChooseAction: "Pilih kegiatan kebun",
  farmWaterAction: "Siram Tanaman",
  farmPlantAction: "Tanam Benih",
  farmHarvestAction: "Panen",
  farmWorkingWater: "Menyiram tanaman...",
  farmWorkingPlant: "Menanam benih...",
  farmWorkingHarvest: "Memanen hasil...",
  farmMovingStatus: "Petani berjalan...",
  farmGrowthResult: "Kebun maju {n} petak!",
